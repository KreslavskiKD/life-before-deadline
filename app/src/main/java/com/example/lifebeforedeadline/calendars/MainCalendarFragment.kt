...
import com.example.lifebeforedeadline.databinding.MainCalendarFragmentBinding
import com.example.lifebeforedeadline.databinding.Example1CalendarDayBinding
import java.time.Month
import java.time.format.TextStyle
import java.util.*

class MainCalendarFragment : BaseFragment(R.layout.main_calendar_fragment), HasToolbar {
    ...
    private lateinit var binding: MainCalendarFragmentBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = MainCalendarFragmentBinding.bind(view)
